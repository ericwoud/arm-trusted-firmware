...
APSOC_BL2_COMMON := $(MTK_PLAT)/apsoc_common/bl2
APSOC_COMMON_DRIVERS := $(MTK_PLAT)/apsoc_common/drivers
...
BL2_SOURCES		+=	$(APSOC_BL2_COMMON)/bl2_plat_setup.c
BL2_CPPFLAGS		+=	-I$(APSOC_BL2_COMMON)
endef

define BL2_BOOT_RAM
$(call BL2_BOOT_COMMON)
BL2_SOURCES		+=	drivers/io/io_memmap.c				\
				$(APSOC_BL2_COMMON)/bl2_boot_ram.c
...
BL2_SOURCES		+=	drivers/io/io_memmap.c				\
				$(APSOC_BL2_COMMON)/bl2_boot_nor_mmap.c
BROM_HEADER_TYPE	?=	nor
...
BL2_SOURCES		+=	drivers/mtd/nor/spi_nor.c			\
				...
				$(APSOC_BL2_COMMON)/bl2_boot_nor.c		\
				$(APSOC_BL2_COMMON)/bl2_dev_spi_nor_init.c
...
BL2_SOURCES		+=	drivers/mmc/mmc.c				\
				...
				$(APSOC_BL2_COMMON)/bl2_boot_mmc.c
...
BL2_SOURCES		+=	$$(NMBM_SOURCES)				\
				$(APSOC_BL2_COMMON)/bl2_boot_nand_nmbm.c
...
BL2_SOURCES		+=	drivers/io/ubi/io_ubi.c				\
				...
				$(APSOC_BL2_COMMON)/bl2_boot_nand_ubi.c
...
ifneq ($$(NMBM),1)
ifneq ($$(UBI),1)
BL2_SOURCES		+=	$(APSOC_BL2_COMMON)/bl2_boot_nand.c
endif
endif
...
BL2_SOURCES		+=	$$(MTK_SNAND_SOURCES)				\
				$(APSOC_BL2_COMMON)/bl2_dev_snfi_init.c		\
				drivers/mtd/nand/core.c
BL2_CPPFLAGS		+=	-I$(MTK_PLAT)/common/drivers/snfi
...
BL2_SOURCES		+=	drivers/mtd/nand/core.c				\
				$(APSOC_COMMON_DRIVERS)/spi_nand/mtk_spi_nand.c	\
				drivers/mtd/spi-mem/spi_mem.c			\
				$(APSOC_BL2_COMMON)/bl2_dev_spi_nand_init.c
BL2_CPPFLAGS		+=	-Iinclude/lib/libfdt
BL2_CPPFLAGS		+=	-I$(APSOC_COMMON_DRIVERS)/spi_nand
