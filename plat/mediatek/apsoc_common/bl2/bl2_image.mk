...
define DUAL_FIP_UNSUPPORTED
ifeq ($$(DUAL_FIP),1)
$$(error Dual-FIP is not supported by current boot device.)
endif
endef

define BL2_BOOT_RAM
$(call BL2_BOOT_COMMON)
$(call DUAL_FIP_UNSUPPORTED)
...
BL2_SOURCES		+=	$(APSOC_COMMON)/bl2/uart_dl.c			\
				$(APSOC_COMMON)/drivers/uart/hsuart-extra.c
...
BL2_CPPFLAGS		+=	-DFAT32BUFFER_SIZE=0x1000000
