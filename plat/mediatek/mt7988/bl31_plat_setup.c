...
entry_point_info_t *bl31_plat_get_next_kernel_ep_info(kernel_arch k32_64)
{
	...
	if (k32_64 == KERNEL_AARCH32) {
		...
		next_image_info->spsr = SPSR_MODE32(
			NON_SECURE, SPSR_T_ARM, SPSR_E_LITTLE,
...
void bl31_prepare_kernel_entry(uint64_t k32_64)
{
	...
	if (k32_64 == 0)
		next_image_info =
			bl31_plat_get_next_kernel_ep_info(KERNEL_AARCH32);
	else
		next_image_info =
			bl31_plat_get_next_kernel_ep_info(KERNEL_AARCH64);
